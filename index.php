...
<body>
    ...
    <!-- Code 01_basics.php as described/written in the video -->
...
<!-- Code 02_MoreBasics.php as described/written in the video -->
...
<!-- Code 03_strings.php as described/written in the video -->
<?php
    $str = "This this this";
    echo $str. "<br>";
    $lenn = strlen($str);
